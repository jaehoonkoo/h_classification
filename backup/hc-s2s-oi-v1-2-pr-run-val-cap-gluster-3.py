...
if model_name == 'hc':
   ...
   primary_capsule = PrimaryCapsule(n_vector=32, n_channel=32, n_kernel_size=7, n_stride=1)(pred)
   ...
   digit_capsule = CapsuleLayer(n_capsule=n_classes, n_vec=32, n_routing=n_routing, name='digit_capsule')(primary_capsule)

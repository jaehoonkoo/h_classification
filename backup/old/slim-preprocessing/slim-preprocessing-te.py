...
save_dir = '/scratch/jkoo/data/open-images/arrays/test_npy_b256_slim/'

# file_names = np.load(home_dir + 'ilsvrc65.train.subset0.name.npy')[:,0]  ##################################################
file_names = np.load(home_dir + 'te_img_path.npy')
...
for i in range(start,end):
    ...
    if i % batch_size == 0:
       processed_image = vgg_preprocessing.preprocess_image(tf.constant(image), image_size, image_size, is_training=False) ##################
